...
MODEL                   = continuousProcess
MODULES                 = rt_logging.c continuousProcess.c continuousProcess_capi.c continuousProcess_data.c continuousProcess_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = continuousProcess
MAKEFILE                = continuousProcess.mk
MATLAB_ROOT             = /usr/local/MATLAB/R2020b
ALT_MATLAB_ROOT         = /usr/local/MATLAB/R2020b
START_DIR               = /home/sergio/Dropbox/AC/Meta3/AC/Assignment3/Part_A
S_FUNCTIONS_LIB         = 
NUMST                   = 3
NCSTATES                = 5
COMPUTER                = GLNXA64
BUILDARGS               =  RSIM_SOLVER_SELECTION=2 PCMATLABROOT="/usr/local/MATLAB/R2020b" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DENABLE_SLEXEC_SSBRIDGE=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/continuousProcess \
